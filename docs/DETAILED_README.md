...
## 📊 Phase 2: Data Collection & Replay

Phase 2 extends the system with data collection and replay capabilities:

### New Features

- **Episode Recording**: Record teleoperation demonstrations at 30 Hz
- **Episode Replay**: Reproducible playback of recorded trajectories
- **Success Evaluation**: Automated evaluation of task completion
- **Dataset Management**: Index and statistics for collected episodes
- **Interactive Browser**: Browse and visualize recorded episodes
...
# Replay episodes
python replay.py --episode episodes/ep_XXXXX.npz

# Manage dataset
python dataset_manager.py --update --stats

# Browse dataset
python dataset_viewer.py
```

See [PHASE2_GUIDE.md](PHASE2_GUIDE.md) for detailed usage instructions.

### Phase 2 Capabilities

- ✅ End-to-end data pipeline (teleop → recording → replay)
- ✅ Automated success evaluation (lift height + target zone)
- ✅ Dataset indexing and statistics
- ✅ Joint replay mode for deterministic reproduction
- ✅ Task definition: Pick cube → Place in target zone
...
- **Multi-hand Coordination**: Dual-hand teleoperation
